...
//// Good - 12/23/2023
        ...
        //alert(`Congratulations! You successfully identified ${targetCapital} as the capital of ${targetState} in just ${attemptCount} attempts.`);


        ///Code to tie in map input should go here///
